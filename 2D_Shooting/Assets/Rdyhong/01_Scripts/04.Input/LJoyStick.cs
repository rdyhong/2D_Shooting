...
public class LJoyStick : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    void OnTouch(Vector2 vecTouch)
    {
        ...
        weight = InputMgr.isRun ? Mathf.Lerp(weight, 1, 0.2f) : Mathf.Lerp(weight, _weight, 0.2f);

        InputMgr.weight = weight;
        InputMgr.Inst.Dir = vec;
    ...
    public void OnPointerUp(PointerEventData eventData)
    {
        ...
        InputMgr.Inst.Dir = Vector2.zero;
    }
